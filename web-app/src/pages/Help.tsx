  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5 py-2">
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-5 text-sm text-blue-950 dark:border-blue-900 dark:bg-blue-950/30 dark:text-blue-100">
        ...
        <p className="mt-2">The complete staff workflow is maintained in <a className="text-blue-600 underline" href="https://github.com/isaacmain254/open-sacco/blob/main/USER_GUIDE.md">USER_GUIDE.md</a> at the root of the {SYSTEM_NAME} project repository.</p>
      </div>
    </div>
  )
}
