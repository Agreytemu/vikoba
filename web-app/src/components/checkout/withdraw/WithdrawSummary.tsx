 ...
 * fee (TZS 0 for Snippe payouts). Total is always amount + fee — never a value
 * the frontend invents.
 */
const WithdrawSummary: FC<WithdrawSummaryProps> = ({
  amount,
  method,
  phone,
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-card dark:border-slate-800 dark:bg-slate-900">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="font-display text-[16px] font-semibold">Withdrawal summary</h2>
      ...
      <dl className="space-y-2.5 text-sm">
        <div className="flex items-center justify-between">
          <dt className="text-slate-500 dark:text-slate-400">Withdrawal amount</dt>
        ...
        <div className="flex items-center justify-between">
          <dt className="text-slate-500 dark:text-slate-400">To your number</dt>
