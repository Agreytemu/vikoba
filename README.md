...
Vikoba Kidigitali is an open-source savings and credit cooperative (SACCO / VICOBA) management system. It provides a Django REST API and a React web application for member management, savings accounts, transactions, and loan applications. The web app ships with multi-language support (English by default, with country-based language detection) and a mobile-first interface.
...
You can test Vikoba Kidigitali without a local setup at [vikoba-kidigitali.vercel.app](https://vikoba-kidigitali.vercel.app/). The deployed backend has already been migrated and seeded with demo data.
...
USER_GUIDE.md Short guide for Vikoba Kidigitali staff
```
